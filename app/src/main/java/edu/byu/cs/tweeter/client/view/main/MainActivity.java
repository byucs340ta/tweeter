...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    public void updateSelectedUserFollowingAndFollowers() {
        presenter.getFollowCounts(selectedUser);
    }
    ...
    @Override
    public void postFollowUserStatusChange(boolean canFollowUser) {
        updateSelectedUserFollowingAndFollowers();
        updateFollowButton(canFollowUser);
    }

    @Override
    public void postStatusPosted() {
        postingToast.cancel();
